...
export MAX_RESP_LENGTH=10240  # TODO: 31744 /15360 / 7168 / 3072 / 5120
...
export AH_OPD_OVERLAP_WEIGHT=${AH_OPD_OVERLAP_WEIGHT:-0.55}
export AH_OPD_ENTROPY_WEIGHT=${AH_OPD_ENTROPY_WEIGHT:-0.25}
export AH_OPD_REWARD_WEIGHT=${AH_OPD_REWARD_WEIGHT:-0.20}
...
export RUN_NAME=${RUN_NAME:-${ADV_ESTIMATOR}_${TRAIN_DATASET_NAME}_${ACTOR_MODEL_NAME}_${REWARD_MODEL_NAME}_${MAX_RESP_LENGTH}-T_${TEMPERATURE}-Tch_${TEACHER_TEMPERATURE}-n_${N_RESPONSES}-mbs_${MINI_BATCH_SIZE}-topk_${LOG_PROB_TOP_K}-topk_strategy_${TOP_K_STRATEGY}-rw_${REWARD_WEIGHT_MODE}-ah_min_${AH_OPD_MIN_HORIZON}-ah_win_${AH_OPD_WINDOW_SIZE}-ah_thr_${AH_OPD_THRESHOLD}-dtype_${MODEL_DTYPE}}
