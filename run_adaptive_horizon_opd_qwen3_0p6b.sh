...
export RUN_NAME=${RUN_NAME:-ahopd_transition_${TRAIN_DATASET_NAME}_${ACTOR_MODEL_NAME}_${REWARD_MODEL_NAME}_${MAX_RESP_LENGTH}-n${N_RESPONSES}-mbs${MINI_BATCH_SIZE}-thr${AH_OPD_THRESHOLD}-pat${AH_OPD_PATIENCE_WINDOWS}-tpow${AH_OPD_TRANSITION_POWER}-gtau${AH_OPD_ENTROPY_GAP_TEMPERATURE}-pwin${AH_OPD_PREFIX_WINDOW_SIZE}-${MODEL_DTYPE}}
