...
export AH_OPD_THRESHOLD=${AH_OPD_THRESHOLD:-0.45}
export AH_OPD_PATIENCE_WINDOWS=${AH_OPD_PATIENCE_WINDOWS:-2}
export AH_OPD_SUFFIX_WEIGHT=${AH_OPD_SUFFIX_WEIGHT:-0.0}
