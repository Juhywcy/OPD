...
from verl.trainer.ppo import core_algos_odw_opd as core_algos
from verl.trainer.ppo.core_algos_odw_opd import AdvantageEstimator, agg_loss
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.use_rm and "rm_scores" not in batch.batch.keys():
                            ...
                            topk_renormalize = self.config.algorithm.get("odw_opd", {}).get("topk_renormalize", True)
