...
export RUN_NAME=${RUN_NAME:-oal_${OAL_SPLIT_MODE}_${ACTOR_MODEL_NAME}_${REWARD_MODEL_NAME}_topk${LOG_PROB_TOP_K}-renorm${OPD_TOPK_RENORMALIZE}-margin${OAL_MARGIN}-${MODEL_DTYPE}}
