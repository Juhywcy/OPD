...
export ADV_ESTIMATOR=${ADV_ESTIMATOR:-outcome_aligned_logit_opd}
...
export RUN_NAME=${RUN_NAME:-oal_opd_${TRAIN_DATASET_NAME}_${ACTOR_MODEL_NAME}_${REWARD_MODEL_NAME}_${MAX_RESP_LENGTH}-n${N_RESPONSES}-mbs${MINI_BATCH_SIZE}-margin${OAL_MARGIN}-${MODEL_DTYPE}}
